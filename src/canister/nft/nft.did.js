export const idlFactory = ({ IDL }) => {
  ...
  const Canister = IDL.Service({
    ...
    'addJSON' : IDL.Func([TokenIndex, IDL.Text], [], ['oneway']),
    ...
    'mintMultipleNFT' : IDL.Func([IDL.Vec(MintingRequest)], [], ['oneway']),
    ...
    'transferDebug' : IDL.Func(
        [TransferRequest],
        [IDL.Text, IDL.Text, IDL.Text, IDL.Text, IDL.Text, IDL.Text],
        [],
      ),
    'transferDistrikt' : IDL.Func(
