...
export interface Canister {
  ...
  'addJSON' : (arg_0: TokenIndex, arg_1: string) => Promise<undefined>,
  ...
  'caller' : () => Promise<[string, string, boolean, boolean]>,
  ...
  'getAsset' : () => Promise<Array<[AssetHandle, Asset]>>,
  'getAssetURLByIndex' : (arg_0: TokenIndex) => Promise<string>,
  'getAssetURLByTokenId' : (arg_0: TokenIdentifier__1) => Promise<string>,
  'getJSON' : (arg_0: TokenIndex) => Promise<string>,
  ...
  'mintMultipleNFT' : (arg_0: Array<MintingRequest>) => Promise<undefined>,
  ...
  'salesStats' : (arg_0: AccountIdentifier__1) => Promise<
      [bigint, [] | [Time], [string, bigint, bigint, boolean], boolean]
    >,
  ...
  'transferDebug' : (arg_0: TransferRequest) => Promise<
      [string, string, string, string, string, string]
    >,
  'transferDistrikt' : (arg_0: string, arg_1: string, arg_2: number) => Promise<
      boolean
    >,
}
